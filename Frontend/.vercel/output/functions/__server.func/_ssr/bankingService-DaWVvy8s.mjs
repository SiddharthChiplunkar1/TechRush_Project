...
//#region node_modules/.nitro/vite/services/ssr/assets/bankingService-DaWVvy8s.js
...
var bankingService = {
	...
	updateBeneficiary: (id, payload) => api.put(`/api/banking/beneficiaries/${encodeURIComponent(id)}`, payload).then(unwrap),
	deleteBeneficiary: (id) => api.delete(`/api/banking/beneficiaries/${encodeURIComponent(id)}`),
	setBeneficiaryFavorite: (id, favourite) => api.post(`/api/banking/beneficiaries/${encodeURIComponent(id)}/favorite`, null, { params: { fav: favourite } }),
	...
	verifyStepUpChallenge: (challengeId, otp) => api.post(`/api/banking/step-up/challenges/${challengeId}/verify`, { otp }).then(unwrap),
	getTransactions: (params = {}) => api.get("/api/banking/transactions", { params }).then(unwrap)
};
//#endregion
export { bankingService as t };
